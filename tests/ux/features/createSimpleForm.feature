...
Scenario: Add a Text Field
    ...
    And   I click on the element "body > div:nth-child(2) > div > div.yui3-widget-bd.modal-body > div:nth-child(2) > div > input"
    And   I press "first_name"
    And   I click on the element "body > div:nth-child(2) > div > div.yui3-widget-bd.modal-body > div:nth-child(4) > div > input"
